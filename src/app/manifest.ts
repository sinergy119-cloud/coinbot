...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    lang: 'ko',
    icons: [
      { src: '/intro.png', sizes: '192x192', type: 'image/png', purpose: 'any' },
      { src: '/intro.png', sizes: '512x512', type: 'image/png', purpose: 'any' },
      { src: '/intro.png', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
    ],
  }
}
