...
export async function GET(req: NextRequest) {
  ...
  if (existingUser) {
    ...
    return Response.redirect(`${origin}${target}?welcome=kakao`)
  }
  ...
  try {
    ...
    return await setPendingSignupOnResponse(res, { provider: 'kakao' as 'naver', userId: kakaoUserId, name: nickname, email })
  } catch (err) {
