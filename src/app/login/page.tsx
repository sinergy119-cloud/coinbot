          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <button
              ...
              onClick={() => {
                ...
                window.location.href = `https://kauth.kakao.com/oauth/authorize?client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&state=${state}&scope=profile_nickname,account_email`
              }}
